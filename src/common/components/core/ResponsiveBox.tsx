...
const ResponsiveBox = (props: Readonly<CoreComponentsProps>) => {
  ...
  return (
    <div
      className={`relative flex flex-col justify-center items-center w-full h-auto p-0 mx-auto my-0 overflow-hidden transition duration-300 ease-in-out ${classNames}`}
      id={id}
      ref={elementRef}
      onClick={onClick}
    >
