...
const HomeSection1 = ({ id }: Readonly<{ id: string }>) => {
  return (
    <ResponsiveBox
      ...
      id={id}
    >
      <ConstrainedBox classNames="px-4 py-8 pt-20 z-20 items-center justify-center text-center">
        <div className="w-full items-center flex flex-col items-center justify-center text-center">
